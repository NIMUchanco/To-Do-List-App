...
export const displayData = (data, username) => {
    ...
    if (note.isDeleted == 0) {
        ...
        li.innerHTML = `
            <div class="card">
                ...
                <div class="right">
                    ...
                    <div class="btn">
                        <button class="edit" data-noteid="${note.noteID}">
        ...
        if (note.isChecked == 1) {
            ...
            li.querySelector(".subject").style.textDecoration = "line-through";
            li.querySelector(".card").style.backgroundColor = "rgba(38, 38, 38, .7)";
            li.querySelector(".card").style.color = "#f2f7f2";
            li.querySelector(".edit").style.display = "none";
            li.querySelector(".btn").style.gap = "0";
        }
...
const closeBtn = document.querySelector('.mask i');
const logoutBtn = document.querySelector('#logout-btn');
const submitBtn = document.querySelector('#submit');
const noteSubject = document.querySelector('#note_subject');
...
submitBtn.addEventListener('click', () => {
    if (noteSubject.value.trim() === '' || noteText.value.trim() === '') {
